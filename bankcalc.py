...
if click_opt == 'Deposit' :
    ...
    if  click_dep :
        ...
        st.sidebar.error( f''' Note all 3 items marked * below must be available to proceed.''')
        ...
        if dep_pro:
            ...
            st.write(f" Note all information marked * must be provided. ")   
            ...
            st.error(" All information marked * in the checklist must be available to proceed. ")
